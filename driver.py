...
pull_data.get_data_code_seed("PLO", 1, 1, opt_trustworthy = False)
#pull_data.get_data_code_seed("PLO", "P", 1, opt_trustworthy = False)
pull_data.get_data_code_seed("PLO", 1, 2, opt_trustworthy = False)
#pull_data.get_data_code_seed("PLO", "P", 2, opt_trustworthy = False)
pull_data.get_data_code_seed("PLO", 1, 3, opt_trustworthy = False)
